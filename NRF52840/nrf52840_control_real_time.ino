...
int enc1=6;// pins used
int enc2=5;// for encoder
...
void setup() {
  ...
  PWM_Instance= new nRF52_PWM(pwm_pin,freq,duty_cycle);
  if(PWM_Instance)
  {
    PWM_Instance->setPWM();
  }
...
// waits until Serial monitor is connected
  ...
  if (ITimer.attachInterrupt(TIMER0_FREQ_HZ, TimerHandler0))
  {
